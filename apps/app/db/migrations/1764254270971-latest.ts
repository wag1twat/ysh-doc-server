...
export class Latest1764254270971 implements MigrationInterface {
    name = 'Latest1764254270971'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "credentials" ADD CONSTRAINT "UQ_8d3a07b8e994962efe57ebd0f20" UNIQUE ("userId")`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "credentials" DROP CONSTRAINT "UQ_8d3a07b8e994962efe57ebd0f20"`);
        ...
        await queryRunner.query(`ALTER TABLE "users" ADD CONSTRAINT "FK_d6d50143a16c49c49bf467ae541" FOREIGN KEY ("credentialId") REFERENCES "credentials"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
    }
